...
RB_METHOD(CUSLSetStat)
{
    ...
    else { rb_raise(rb_eTypeError, "Statistic value must be either an integer or float."); }
...
void CUSLBindingInit()
{
    ...
    _rb_define_module_function(mSteamLite, "clear_achievement", CUSLClearAchievement);
    _rb_define_module_function(mSteamLite, "get_achievement_and_unlock_time", CUSLGetAchievementAndUnlockTime);
