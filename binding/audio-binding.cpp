...
#define BIND_FADE(entity) _rb_define_module_function(module, #entity "_fade", audio_##entity##Fade);

#define BIND_PLAY_STOP_FADE(entity)                                                                                    \
    BIND_PLAY_STOP(entity)                                                                                             \
    BIND_FADE(entity)

#define BIND_POS(entity) _rb_define_module_function(module, #entity "_pos", audio_##entity##Pos);
