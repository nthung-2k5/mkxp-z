...
std::unordered_map<int, int> vKeyToScancode{
    ...
    // 0x1e ACCEPT
    // 0x1f MODECHANGE
    m(0x20, SPACE), m(0x21, PAGEUP), m(0x22, PAGEDOWN), m(0x23, END), m(0x24, HOME), m(0x25, LEFT), m(0x26, UP),
    m(0x27, RIGHT), m(0x28, DOWN), m(0x29, SELECT),
    // 0x2A print
    m(0x2b, EXECUTE), m(0x2c, PRINTSCREEN), m(0x2d, INSERT), m(0x2e, DELETE), m(0x2f, HELP), m(0x30, 0), m(0x31, 1),
    m(0x32, 2), m(0x33, 3), m(0x34, 4), m(0x35, 5), m(0x36, 6), m(0x37, 7), m(0x38, 8), m(0x39, 9),
    // 0x3a-0x40 undefined
    m(0x41, A), m(0x42, B), m(0x43, C), m(0x44, D), m(0x45, E), m(0x46, F), m(0x47, G), m(0x48, H), m(0x49, I),
    m(0x4a, J), m(0x4b, K), m(0x4c, L), m(0x4d, M), m(0x4e, N), m(0x4f, O), m(0x50, P), m(0x51, Q), m(0x52, R),
    m(0x53, S), m(0x54, T), m(0x55, U), m(0x56, V), m(0x57, W), m(0x58, X), m(0x59, Y), m(0x5a, Z), m(0x5b, LGUI),
    m(0x5c, RGUI), m(0x5d, APPLICATION),
    // 0x5e reserved
    m(0x5f, SLEEP), m(0x60, KP_0), m(0x61, KP_1), m(0x62, KP_2), m(0x63, KP_3), m(0x64, KP_4), m(0x65, KP_5),
    m(0x66, KP_6), m(0x67, KP_7), m(0x68, KP_8), m(0x69, KP_9), m(0x6a, KP_MULTIPLY), m(0x6b, KP_PLUS),
    m(0x6c, RETURN), // SEPARATOR
    m(0x6d, KP_MINUS), m(0x6e, KP_DECIMAL), m(0x6f, KP_DIVIDE), m(0x70, F1), m(0x71, F2), m(0x72, F3), m(0x73, F4),
    m(0x74, F5), m(0x75, F6), m(0x76, F7), m(0x77, F8), m(0x78, F9), m(0x79, F10), m(0x7a, F11), m(0x7b, F12),
    m(0x7c, F13), m(0x7d, F14), m(0x7e, F15), m(0x7f, F16), m(0x80, F17), m(0x81, F18), m(0x82, F19), m(0x83, F20),
    m(0x84, F21), m(0x85, F22), m(0x86, F23), m(0x87, F24),
    // 0x88-0x8f unassigned
    m(0x90, NUMLOCKCLEAR), m(0x91, SCROLLLOCK),
    // 0x92-0x96 oem specific
    // 0x97-0x9f unassigned
    m(0xa0, LSHIFT), m(0xa1, RSHIFT), m(0xa2, LCTRL), m(0xa3, RCTRL), m(0xa4, LALT), m(0xa5, RALT), m(0xa6, AC_BACK),
    m(0xa7, AC_FORWARD), m(0xa8, AC_REFRESH), m(0xa9, AC_STOP), m(0xaa, AC_SEARCH),
    // 0xab BROWSER_FAVORITES
    m(0xac, AC_HOME), m(0xad, AUDIOMUTE), m(0xae, VOLUMEDOWN), m(0xaf, VOLUMEUP), m(0xb0, AUDIONEXT),
    m(0xb1, AUDIOPREV), m(0xb2, AUDIOSTOP), m(0xb3, AUDIOPLAY), m(0xb4, MAIL), m(0xb5, MEDIASELECT),
    // 0xb6 LAUNCH_APP1
    // 0xb7 LAUNCH_APP2
    // 0xb8-0xb9 reserved
    ...
    m(0xba, SEMICOLON), m(0xbb, EQUALS), m(0xbc, COMMA), m(0xbd, MINUS), m(0xbe, PERIOD), m(0xbf, SLASH),
    m(0xc0, GRAVE),
    // 0xc1-0xd7 reserved
    // 0xd8-0xda unassigned
    m(0xdb, LEFTBRACKET), m(0xdc, BACKSLASH), m(0xdd, RIGHTBRACKET), m(0xde, APOSTROPHE),
    // 0xdf OEM_8
    // 0xe0 reserved
    // 0xe1 oem-specific
    // 0xe2 OEM_102
...
#define m(keycode)                                                                                                     \
    {                                                                                                                  \
        #keycode, SDL_SCANCODE_##keycode                                                                               \
    }
#define m_number(keycode)                                                                                              \
    {                                                                                                                  \
        "NUMBER_" #keycode, SDL_SCANCODE_##keycode                                                                     \
    }
...
#define m(ctrl)                                                                                                        \
    {                                                                                                                  \
        #ctrl, SDL_CONTROLLER_BUTTON_##ctrl                                                                            \
    }

std::unordered_map<std::string, SDL_GameControllerButton> strToGCButton{m(A),
                                                                        m(B),
                                                                        m(X),
                                                                        m(Y),
                                                                        m(BACK),
...
const char* axisNames[]{"LStick X", "LStick Y", "RStick X", "RStick Y", "LTrigger", "RTrigger"};

const char* buttonNames[]{"Pad A",       "Pad B",       "Pad X",       "Pad Y",    "Pad Back",    "Pad Guide",
                          "Pad Start",   "Pad LS",      "Pad RS",      "Pad LB",   "Pad RB",      "Pad Up",
                          "Pad Down",    "Pad Left",    "Pad Right",   "Pad Misc", "Pad Paddle1", "Pad Paddle2",
                          "Pad Paddle3", "Pad Paddle4", "Pad Touchpad"};
...
struct ButtonState
{
    ...
    ButtonState(): pressed(false), triggered(false), repeated(false), released(false) {}
};
...
struct KbBinding: public Binding
{
    ...
    KbBinding(const KbBindingData& data): Binding(data.target), source(data.source) {}

    bool sourceActive() const
    {
        /* Special case aliases */
        if (source == SDL_SCANCODE_LSHIFT)
            return EventThread::keyStates[source] || EventThread::keyStates[SDL_SCANCODE_RSHIFT];

        if (source == SDL_SCANCODE_RETURN)
            return EventThread::keyStates[source] || EventThread::keyStates[SDL_SCANCODE_KP_ENTER];
...
struct CtrlButtonBinding: public Binding
{
    ...
    bool sourceActive() const { return EventThread::controllerState.buttons[source]; }
...
struct CtrlAxisBinding: public Binding
{
    ...
    CtrlAxisBinding(uint8_t source, AxisDir dir, Input::ButtonCode target): Binding(target), source(source), dir(dir) {}
...
struct MsBinding: public Binding
{
    ...
    MsBinding(int buttonIndex, Input::ButtonCode target): Binding(target), index(buttonIndex) {}
...
static const KbBindingData staticKbBindings[] = {
    {SDL_SCANCODE_LSHIFT, Input::Shift}, {SDL_SCANCODE_RSHIFT, Input::Shift}, {SDL_SCANCODE_LCTRL, Input::Ctrl},
    {SDL_SCANCODE_RCTRL, Input::Ctrl},   {SDL_SCANCODE_LALT, Input::Alt},     {SDL_SCANCODE_RALT, Input::Alt},
    {SDL_SCANCODE_F5, Input::F5},        {SDL_SCANCODE_F6, Input::F6},        {SDL_SCANCODE_F7, Input::F7},
    {SDL_SCANCODE_F8, Input::F8},        {SDL_SCANCODE_F9, Input::F9}};

static elementsN(staticKbBindings);

/* Maps ButtonCode enum values to indices
 * in the button state array */
static const int mapToIndex[] = {0,  0,  1, 0,  2,  0,  3,  0,  4, 0, 0, 5, 6, 7, 8, 9, 10, 11, 12, 0,  0, 13,
                                 14, 15, 0, 16, 17, 18, 19, 20, 0, 0, 0, 0, 0, 0, 0, 0, 21, 22, 23, 24, 25};

static elementsN(mapToIndex);

static const Input::ButtonCode dirs[] = {Input::Down, Input::Left, Input::Right, Input::Up};

static const int dirFlags[] = {1 << Input::Down, 1 << Input::Left, 1 << Input::Right, 1 << Input::Up};

/* Dir4 is always zero on these combinations */
static const int deadDirFlags[] = {dirFlags[0] | dirFlags[3], dirFlags[1] | dirFlags[2]};
...
struct InputPrivate
{
    ...
    inline ButtonState& getState(Input::ButtonCode code) { return states[mapToIndex[code]]; }

    inline ButtonState& getOldState(Input::ButtonCode code) { return statesOld[mapToIndex[code]]; }
    ...
    ButtonState getStateRaw(int code, bool useVKey)
    {
        ...
        b.repeated =
            (rawRepeating == scancode) && (rawRepeatCount >= repeatStart && ((rawRepeatCount + 1) % repeatDelay) == 0);
    ...
    ButtonState getControllerButtonState(int button)
    {
        ...
        b.repeated = (buttonRepeating == button) &&
                     (buttonRepeatCount >= repeatStart && ((buttonRepeatCount + 1) % repeatDelay) == 0);
    ...
    void pollBindings(Input::ButtonCode& repeatCand)
    {
        ...
        for (Binding* bind: bindings)
        {
            ...
            if (!state.pressed && oldState.pressed) state.released = true;
        }
    ...
    void pollBindingPriv(const Binding& b, Input::ButtonCode& repeatCand)
    {
        ...
        if (!oldState.pressed) state.triggered = true;
    ...
    void updateRaw()
    {
        ...
        for (int i = 0; i < SDL_NUM_SCANCODES; i++)
        {
            ...
            {
                if (rawRepeating == i) { rawRepeatCount++; }
                else
                {
                    rawRepeatCount = 0;
    ...
    void updateDir8()
    {
        static const int combos[4][4] = {{2, 1, 3, 0}, {1, 4, 0, 7}, {3, 0, 6, 9}, {0, 7, 9, 8}};
...
bool Input::isTriggered(int button) { return p->getStateCheck(button).triggered; }
...
{
    if (button != p->repeating) return 0;
...
bool Input::isPressedEx(int code, bool isVKey) { return p->getStateRaw(code, isVKey).pressed; }

bool Input::isTriggeredEx(int code, bool isVKey) { return p->getStateRaw(code, isVKey).triggered; }

bool Input::isRepeatedEx(int code, bool isVKey) { return p->getStateRaw(code, isVKey).repeated; }

bool Input::isReleasedEx(int code, bool isVKey) { return p->getStateRaw(code, isVKey).released; }

bool Input::controllerIsPressedEx(int button) { return p->getControllerButtonState(button).pressed; }

bool Input::controllerIsTriggeredEx(int button) { return p->getControllerButtonState(button).triggered; }

bool Input::controllerIsRepeatedEx(int button) { return p->getControllerButtonState(button).repeated; }

bool Input::controllerIsReleasedEx(int button) { return p->getControllerButtonState(button).released; }
...
{
    if (button != p->buttonRepeating) return 0;
...
unsigned int Input::rawKeyStatesLength() { return sizeof(p->rawStateArray) / 2; }

uint8_t* Input::rawButtonStates() { return p->rawButtonStates; }

unsigned int Input::rawButtonStatesLength() { return sizeof(p->rawButtonStateArray) / 2; }

int16_t* Input::rawAxes() { return p->axisStateArray; }

unsigned int Input::rawAxesLength() { return sizeof(p->axisStateArray) / sizeof(int16_t); }

short Input::getControllerAxisValue(SDL_GameControllerAxis axis)
{
    if (axis < 0 || (uint32_t)axis >= rawAxesLength()) return 0;
...
bool Input::getControllerConnected() { return shState->eThread().getControllerConnected(); }

const char* Input::getControllerName()
{
    return (getControllerConnected()) ? SDL_GameControllerName(shState->eThread().controller()) : 0;
}

int Input::getControllerPowerLevel()
{
    if (!getControllerConnected()) return SDL_JOYSTICK_POWER_UNKNOWN;

    SDL_Joystick* js = SDL_GameControllerGetJoystick(shState->eThread().controller());
    return SDL_JoystickCurrentPowerLevel(js);
}

bool Input::getTextInputMode() { return (SDL_IsTextInputActive() == SDL_TRUE); }

void Input::setTextInputMode(bool mode) { shState->eThread().requestTextInputMode(mode); }

const char* Input::getText() { return shState->eThread().textInputBuffer.c_str(); }
...
char* Input::getClipboardText()
{
    ...
    if (!tx) throw Exception(Exception::SDLError, "Failed to get clipboard text: %s", SDL_GetError());
    return tx;
}
...
{
    if (axis < 0 || axis >= SDL_CONTROLLER_AXIS_MAX) return "Invalid";
...
{
    if (button < 0 || button >= SDL_CONTROLLER_BUTTON_MAX) return "Invalid";
