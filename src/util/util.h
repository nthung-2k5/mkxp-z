...
#define DEF_ATTR_RD_SIMPLE(klass, name, type, location) DEF_ATTR_RD_SIMPLE_DETAILED(klass, name, type, location, const)
#define DEF_ATTR_SIMPLE(klass, name, type, location) DEF_ATTR_SIMPLE_DETAILED(klass, name, type, location, const)

#define DEF_ATTR_SIMPLE_STATIC(klass, name, type, location) DEF_ATTR_SIMPLE_DETAILED(klass, name, type, location, )
