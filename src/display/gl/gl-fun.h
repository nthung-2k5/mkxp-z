...
typedef void(APIENTRYP _PFNGLREADPIXELSPROC)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format,
...
typedef void(APIENTRYP _PFNGLBLENDFUNCSEPARATEPROC)(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha,
                                                    GLenum dfactorAlpha);
...
typedef void(APIENTRYP _PFNGLTEXIMAGE2DPROC)(GLenum target, GLint level, GLint internalformat, GLsizei width,
                                             GLsizei height, GLint border, GLenum format, GLenum type,
                                             const GLvoid* pixels);
typedef void(APIENTRYP _PFNGLTEXSUBIMAGE2DPROC)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width,
...
/* Debugging */
typedef void(APIENTRY* _GLDEBUGPROC)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length,
...
typedef void(APIENTRYP _PFNGLSHADERSOURCEPROC)(GLuint shader, GLsizei count, const GLchar* const* strings,
                                               const GLint* lengths);
...
typedef void(APIENTRYP _PFNGLUNIFORMMATRIX4FVPROC)(GLint location, GLsizei count, GLboolean transpose,
                                                   const GLfloat* value);
...
typedef void(APIENTRYP _PFNGLVERTEXATTRIBPOINTERPROC)(GLuint index, GLint size, GLenum type, GLboolean normalized,
...
typedef void(APIENTRYP _PFNGLFRAMEBUFFERTEXTURE2DPROC)(GLenum target, GLenum attachment, GLenum textarget,
                                                       GLuint texture, GLint level);
typedef void(APIENTRYP _PFNGLBLITFRAMEBUFFERPROC)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0,
...
#define GL_FBO_BLIT_FUN GL_FUN(BlitFramebuffer, _PFNGLBLITFRAMEBUFFERPROC)
...
#define GL_DEBUG_KHR_FUN GL_FUN(DebugMessageCallback, _PFNGLDEBUGMESSAGECALLBACKPROC)

#define GL_GREMEMDY_FUN GL_FUN(StringMarker, _PFNGLSTRINGMARKERPROC)
